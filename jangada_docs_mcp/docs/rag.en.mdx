...
An optional capability, like audio: **OpenAI, Gemini and Mistral** support it (plus the
OpenAI-compatible Azure/OpenRouter); **Anthropic and Groq** raise `UnsupportedError`.
