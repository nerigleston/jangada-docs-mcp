...
description: "A jangada suporta vários providers (Anthropic, OpenAI, Groq, Gemini, Mistral, OpenRouter e gateways de nuvem), cada um isolado em um adapter que traduz os tipos normalizados (Message/Completion) para o SDK nativo."
---
...
O modo `thinking` é um campo fora do schema típado do SDK oficial da OpenAI —
...
levantam `UnsupportedError`. Veja [DeepSeek](/docs/llm-deepseek) para detalhes.
